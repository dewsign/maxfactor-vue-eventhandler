...
new _vue2.default({
    ...
    created: function created() {
        this.eventHandler.$on('eventhandler-init', function () {
            return console.log('Event handler init');
        });
...
var _EventHandlerMixin = __webpack_require__(10);

var _EventHandlerMixin2 = _interopRequireDefault(_EventHandlerMixin);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var EventHandler = {
    install: function install(Vue) {
        Vue.mixin(_EventHandlerMixin2.default);
    }
};
...
var _EventStore = __webpack_require__(11);
